    ...
    <div className="flex min-h-screen bg-white text-[#111] font-sans text-sm">
      ...
      <aside className="w-[220px] min-h-screen border-r border-[#e8e8e8] flex flex-col py-5 fixed inset-y-0 left-0 bg-white z-10">
        ...
        <div className="flex items-center gap-2.5 px-4 pb-5 border-b border-[#e8e8e8]">
          <div className="w-8 h-8 bg-[#111] rounded-lg flex items-center justify-center text-[10px] font-bold text-white tracking-tight">
            EMSI
          </div>
          <div>
              ...
              {group.items.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ...
                    ${isActive
                      ? "bg-[#111] text-white"
                      : "text-[#888] hover:bg-[#f9f9f9] hover:text-[#111]"
                    }`
                  }
                >
                  {({ isActive }) => (
        ...
        <div className="px-2.5 pt-3.5 border-t border-[#e8e8e8]">
          <div className="flex items-center gap-2.5 p-2 rounded-[10px] cursor-pointer hover:bg-[#f9f9f9] transition-colors">
