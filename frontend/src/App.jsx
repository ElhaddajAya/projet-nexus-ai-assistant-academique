...
import {
  ResultatsListPage,
  ResultatDetailPage,
} from "./pages/student/ResultatsPage";
import RessourcesStudentPage from "./pages/student/RessourcesStudentPage";
import ProfilPage from "./pages/student/ProfilPage";
      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route
              path='resultats'
              element={<ResultatsListPage />}
            />
            <Route
              path='resultats/:id'
              element={<ResultatDetailPage />}
            />
            <Route
              path='ressources'
              element={<RessourcesStudentPage />}
            />
            <Route
              path='/student/profil'
              element={
