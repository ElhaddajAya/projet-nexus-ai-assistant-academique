  ...
  return (
    <div className="min-h-screen bg-[#f9f9f9] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white border border-[#e8e8e8] rounded-[14px] p-8">
        ...
        <h1 className="text-[#111] text-2xl font-bold text-center mb-1">Connexion</h1>
        <p className="text-[#888] text-sm text-center mb-6">Accédez à votre espace OrientAI</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-[#111] mb-1">Mot de passe</label>
            <input
        ...
        <p className="text-center text-sm text-[#888] mt-6">
          ...
          <Link to="/register" className="text-[#22c55e] font-medium hover:underline">S'inscrire</Link>
        </p>
      </div>
    </div>
  );
