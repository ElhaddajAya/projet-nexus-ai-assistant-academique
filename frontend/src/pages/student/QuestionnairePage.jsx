...
const MODULES_BY_FILIERE = {
  ...
  GC: [
    { id: "m6", nom: "Béton armé", sem: "S5" },
    { id: "m7", nom: "Hydraulique", sem: "S5" },
  ],
        ...
        {submitted ? (
            ...
            <div className='flex flex-col items-center text-center gap-4 py-6'>
              ...
              <div>
                ...
                <p className='text-[12px] text-[#888] leading-relaxed max-w-[300px] mx-auto'>
                  Gemini AI analyse votre profil et génère votre plan
          ...
          <Card>
            <div className='flex flex-col items-center text-center gap-4 py-8'>
              ...
              <p className='text-[13px] font-medium'>
                Gemini AI génère votre analyse…
              </p>
            ...
            <div className='flex flex-col gap-2'>
              {modules.length === 0 ? (
                <p className='text-[12px] text-[#888] text-center py-4'>
                  Sélectionnez d'abord une filière à l'étape précédente.
                </p>
              ) : (
                modules.map((m) => (
                  <ChoiceCard
          ...
          <Card>
            ...
            <div className='flex flex-col gap-2'>
              {matieres.length === 0 ? (
                <p className='text-[12px] text-[#888] text-center py-4'>
                  Sélectionnez d'abord un module à l'étape précédente.
                </p>
              ) : (
                matieres.map((m) => (
                  <ChoiceCard
